...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2026 at 12:53 AM
...
ALTER TABLE `transfers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_sender_wallet` (`sender_wallet_id`),
  ADD KEY `fk_receiver_wallet` (`receiver_wallet_id`);
...
--
ALTER TABLE `transfers`
  ADD CONSTRAINT `fk_receiver_wallet` FOREIGN KEY (`receiver_wallet_id`) REFERENCES `wallets` (`id`),
  ADD CONSTRAINT `fk_sender_wallet` FOREIGN KEY (`sender_wallet_id`) REFERENCES `wallets` (`id`);
